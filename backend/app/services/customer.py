    ...
    def create(
        ...
        *,
        ...
        customer = Customer(
            ...
            email=email,
            kyc_documents=[item.model_dump() for item in payload.kyc_documents] if payload.kyc_documents else None,
            ...
            city=payload.city,
            state=payload.state,
            billing_same_as_installation=payload.billing_same_as_installation,
            billing_address_line_1=payload.billing_address_line_1,
            billing_address_line_2=payload.billing_address_line_2,
            billing_landmark=payload.billing_landmark,
            billing_pincode=payload.billing_pincode,
            billing_district=payload.billing_district,
